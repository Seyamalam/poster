    ...
    <div className="w-screen h-screen flex items-center justify-center bg-gray-100 overflow-hidden">
      <div className="w-full h-[150vw] max-h-screen aspect-[2/3] overflow-hidden">
        <div className="w-full h-full overflow-auto bg-white text-black p-4 md:p-8 flex flex-col transform scale-[0.99]">
          ...
          {/* Title */}
          <h2 className="text-3xl md:text-5xl font-bold text-orange-500 mb-4 text-center">Enhancing Cardiovascular Risk Prediction Using Support Vector Machines and Advanced Machine Learning Algorithms</h2>

          {/* Author Information */}
          <div className="bg-orange-400 text-white p-4 mb-4">
            <h3 className="text-xl md:text-2xl font-bold mb-2">Author Information</h3>
            <p className="text-base md:text-lg">Abhijit Pathak, Touhidul Alam Seyam, Arnab Chakraborty, Nurjahan kamal Santa, Eftakar Uddin, Tasmim Akther Mim</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 flex-grow">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="bg-orange-100 p-4">
                <h3 className="text-xl md:text-2xl font-bold text-orange-600 mb-2">Data Preprocessing</h3>
                <p className="text-xs md:text-sm">
            ...
            <div className="flex flex-col gap-4">
             <div className="bg-orange-100 p-4">
                <h3 className="text-xl md:text-2xl font-bold text-orange-600 mb-2">Data Analysis: Blood Pressure</h3>
                <Image 
              ...
              <div className="bg-orange-100 p-4">
                <h3 className="text-xl md:text-2xl font-bold text-orange-600 mb-2">Data Preprocessing Workflow</h3>
                <p className="text-xs md:text-sm">
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-orange-100 p-4">
                <h3 className="text-xl md:text-2xl font-bold text-orange-600 mb-2">Model Performance</h3>

                <p className="text-xs md:text-sm">After EDA, preprocessing, and modeling, we tested the model. The table below shows the performance metrics of the model.</p>

                <table className='border border-black text-xs md:text-sm my-3'>
                  <thead>
                ...
                <p className="text-xs md:text-sm">The results show that sampling techniques improve model performance on imbalanced datasets. However, the Jaccard index needs improvement.</p>
                
                <div className="flex flex-col items-center">
                  <h2 className="text-xl md:text-2xl font-bold w-full text-orange-600 my-4">Confusion Matrix</h2>
                  <table className="border-collapse w-full max-w-md text-xs md:text-sm">
                    <thead>
                      <tr>
              ...
              <div className="bg-orange-100 p-4">
                <h3 className="text-xl md:text-2xl font-bold text-orange-600 mb-2">Optimization</h3>
                <p className="text-xs md:text-sm">We tuned the ratio of the oversample using ADASYN sampling and plotted the precision-recall curve for each ratio threshold.</p>
                <Image 
